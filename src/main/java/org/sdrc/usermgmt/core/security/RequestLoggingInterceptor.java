...
public class RequestLoggingInterceptor extends GenericFilterBean {
	 ...
	 * Although you are using GenericFilterBean your Servlet Filter is not managed by spring
	 *  
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (ugmtClientCredentials == null) {
			//we cannot expect spring to inject the service, but we can lazy set it on the first call
